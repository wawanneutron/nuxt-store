              ...
              <table class="table table-bordered">
                <client-only>
                  ...
                  <tr>
                    ...
                    <td>
                      <button
                        @click="payment(invoice.snap_token)"
                          ...
                          <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <button
                                  v-if="rating.star && rating.review"
                                  @click.prevent="
                                    storeReview(order.id, order.product.id)
                                  "
                                  type="button"
...
export default {
  ...
  methods: {
    ...
    async storeReview(orderId, productId) {
      ...
      // sending data to action "store review vuex"
      await this.$store
        .dispatch("customer/review/storeReview", formData)
        .then(() => {
          this.$nuxt.refresh();
